...
W151_DENSITY_LAS = Path(
    r"/data/shared/project-oil/wx数据/砂砾岩/车镇成像测井/che151HF_20240415XRMI/车151HF-成果数据/车151HF电成像  裂缝LAS文件/车151HF_裂缝参数_P10、P21、P33.las"
)
CHEYE1_DENSITY_LAS = Path(
    r"/data/shared/project-oil/wx数据/砂砾岩/车镇成像测井/车页1HF（导眼）井-FMI/DLIS&LAS成果数据/车页1HF井裂缝密度、裂缝长度、裂缝孔隙度成果数据_3496.5-3755m.las"
)
