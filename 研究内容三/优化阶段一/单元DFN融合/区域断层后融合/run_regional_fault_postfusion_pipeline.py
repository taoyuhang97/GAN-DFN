...
from fault_postfusion_common import DEFAULT_DOCX_PATH, append_lines_to_docx, write_json
from fuse_faults_into_regional_dfn import run_fault_postfusion
...
def main() -> None:
    ...
    fuse_dir = run_root / "02_fault_fused"
