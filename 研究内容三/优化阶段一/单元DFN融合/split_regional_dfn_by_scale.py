...
def main() -> None:
    ...
    for scale_alias, scale_class in SCALE_ALIAS_TO_CLASS.items():
        ...
        subset_csv = run_dir / f"regional_dfn_{scale_alias}_scale.csv"
        subset_vtk = run_dir / f"regional_dfn_{scale_alias}_scale.vtk"
    ...
    summary_csv = run_dir / "regional_dfn_scale_split_summary.csv"
    ...
    summary_json = run_dir / "regional_dfn_scale_split_summary.json"
