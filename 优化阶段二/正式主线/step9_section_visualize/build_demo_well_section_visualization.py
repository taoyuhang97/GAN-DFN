...
def main() -> None:
    ...
    write_segments_csv(args.output_dir / "demo_well_t4_t7_projection_segments.csv", segments)
    write_well_projection_csv(args.output_dir / "well_trajectory_projected.csv", well_df)
    write_surface_curves_csv(args.output_dir / "demo_well_t4_t7_surface_section_curves.csv", surface_curves)
    (args.output_dir / "demo_well_t4_t7_projection_summary.json").write_text(
