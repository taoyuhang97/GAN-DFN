...
DEFAULT_EXIST_EXP_ROOT = FLOW_RESULT_ROOT / "stage1_lstm_uniform_0p2ms" / DEFAULT_STAGE1_EXP_ID
DEFAULT_EXIST_DIR_MAP = {
    str(strata_name): str(DEFAULT_EXIST_EXP_ROOT / f"{sanitize(strata_name)}_lstm")
    for strata_name in DEFAULT_TARGET_STRATA
}
