...
# ===== 2. 准备特征和标签 =====
features = ['SEIS_TRUE'] + [f'SEIS_{i}' for i in range(63)] + ['GR']
# features = ['SEIS_TRUE'] + [f'SEIS_{i}' for i in range(3, 63, 7)] + ['GR']
# features = ['SEIS_TRUE'] + ['GR']
label = 'FRACTURE_FLAG'

df = all_samples_df[features + [label]].dropna()  # 删除含缺失值行
...
# ===== 7. 保存模型与 scaler =====
# model_dir = r"/data/shared/project-oil/wx数据/砂砾岩/研究内容一/XGboost/模型"
